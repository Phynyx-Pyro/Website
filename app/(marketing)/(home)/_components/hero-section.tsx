...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden pb-10 pt-[84px] lg:pb-16">
      <div className="pointer-events-none absolute right-0 top-0 hidden h-[760px] w-[880px] lg:block">
        <Image
      ...
      <div className="relative mx-auto max-w-[1320px] px-5 lg:px-10">
        <div className="grid grid-cols-1 gap-7 lg:grid-cols-12 lg:gap-8">
          <div className="pt-7 lg:col-span-6 lg:pt-16">
            <AnimatedSection>
            ...
            <AnimatedSection delay={80}>
              <h1 className="max-w-[690px] text-[42px] font-bold leading-[.96] tracking-[-.045em] sm:text-[54px] lg:text-[69px]">
                Turn more of the leads you already pay for into patients who{' '}
            ...
            <AnimatedSection delay={160}>
              <p className="mt-6 max-w-[600px] text-[16px] leading-[1.62] text-warm lg:text-[18px]">
                PhynyxPro runs the ads and the system after the click—response,
                qualification, booking, reminders, and attribution from campaign to
                Day 1 Show.
              </p>
            </AnimatedSection>
          ...
          <div className="relative mt-2 h-[430px] lg:col-span-6 lg:mt-0 lg:h-[650px]">
            <div className="absolute inset-0 overflow-hidden rounded-2xl lg:hidden">
              <Image
                src="/images/hero-chiro.jpg"
            ...
            <AnimatedSection delay={180} className="absolute inset-x-3 bottom-4 z-10 lg:bottom-10 lg:left-auto lg:right-0 lg:w-[570px]">
              <div className="overflow-hidden rounded-[15px] border border-white/10 bg-ink/95 text-white shadow-[0_24px_70px_-24px_rgba(20,19,18,.75)] backdrop-blur-sm">
                <div className="flex items-center justify-between border-b border-white/10 px-4 py-3.5 lg:px-5">
                ...
                <p className="border-t border-white/10 px-4 py-3 text-[11px] leading-[1.45] text-white/55 lg:px-5">
