...
export const CONSENT_DISCLOSURES = {
  smsMarketing: 'I agree to receive marketing text messages from PhynyxPro about its services, my growth snapshot, and booking a diagnostic, including automated messages. Message frequency varies. Message and data rates may apply. Reply STOP to opt out or HELP for help. Consent is not a condition of purchase.',
  ...
  aiVoice: 'I agree that PhynyxPro may call the number I provided about its services, my growth snapshot, and diagnostic using an automated system and an artificial or AI-generated voice. Consent is not a condition of purchase. I may revoke consent at any time by asking the caller to stop or contacting PhynyxPro.',
} as const
