...
| 002c/002d | Voice after 1 day only with affirmative AI Voice Marketing Consent; SMS at 15m/day2 only with affirmative Marketing SMS Consent; each rechecks booking, pause, handoff and DND. All three waits now have a Mon–Fri, 9 AM–5 PM advance window. | Active pending enrollments inspected: all were labeled internal QA contacts. A consent-off 002d fixture completed its wait, took the `None` branch and ended without an SMS action. The new windows were read back after full workflow reload; no consent-on call/SMS delivery test yet. |
...
Channel-hours repair: published 002c originally had no advance window on its 1-day wait, so one internal enrollment was due at 11:34 PM CDT; published 002d had no advance window on either the 15-minute or 2-day wait. All three waits were changed to Mon–Fri 9 AM–5 PM and read back after reload. This is a configuration check, not proof of the actual send time for already-enrolled contacts.
